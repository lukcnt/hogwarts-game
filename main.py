# ASCII art representing Hogwarts castle.
print('''
          <|
           A             
          /.\       
...
if choice1.lower() == "stairs":
    ...
    if choice2.lower() == "jump":
        choice3 = input('You found it!!!!! Now you need the password to access the common room. Choose one of three "Fortuna Major", "Abracadabra" or "Wingardium Leviosa": ')
        if choice3.lower() == "fortuna major":
            ...
            print("You got yelled at for using a speell on the guardian. Game Over")
        else:
            print("That's not a option. Game Over")
    elif choice2.lower() == "stay":
        print("You ended up in a dungeon, got attacked by a troll and died... Game Over")
    else:
        print("That's not a option. Game Over")
